...
export default function Dashboard() {
  ...
  const { data: topListingInfo, isLoading } = useQuery({
    queryKey: ['toplisting'],
    queryFn: topListing
  })
...
<div className="mt-8">
  <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
    ...
    {/* Top Listings */}
    <section className="bg-gradient-to-br from-[#0B1220] via-[#111827] to-[#0F172A] rounded-3xl border border-white/10 shadow-2xl overflow-hidden">
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[600px]">
          ...
          <tbody>
            {topListingInfo?.result?.data?.map((item, i) => (
              <tr
                key={i}
